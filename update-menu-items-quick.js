...
const pool = new Pool({
  connectionString: process.env.DATABASE_URL || 'postgresql://postgres:postgres@localhost:5432/imdadur_burger_shop'
});
...
const menuItems = [
  ...
  { name: "Imdadur's JuiceCola", price: 35, category: 'Drinks' },
