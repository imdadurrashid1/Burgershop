...
const User = require('../models/user.simple.js');
const MenuItem = require('../models/menuItem.simple.js');
const ComboDeal = require('../models/comboDeal.pg.js');
const PDFDocument = require('pdfkit');
const { auth, isAdmin } = require('../middleware/auth');
const Order = require('../models/order.simple.js'); // Simple in-memory Order model
...
router.get('/dashboard/export', auth, isAdmin, async (req, res) => {
    try {
        ...
        // Add content to PDF
        doc.fontSize(20).text('Imdadur Burger Shop - Dashboard Report', { align: 'center' });
        doc.moveDown();
